...
excel_files = ['/Users/dmitr/Desktop/MIPT/3 sem/Лабы/Физика/test.xlsx']
...
def main():
    ...
    """ "1" если y = kx + b, "2" если y = kx, "3" чтобы вывести точки"""
    ind = [3]  # используемый метод в соответствующем графике
